...
class _CategoryVideoScreen extends State<CategoryVideoScreen>{
                          ...
                          Column(
                            children: [
                              Row(
                                ...
                                children: [
                                  Text(
                                    categoryResponse!.videos![0].title!,
                                    style: TextStyle(
  ...
  void pagination() async {
    ...
    if ((scrollController.position.pixels >=
        scrollController.position.maxScrollExtent) && (categoryResponse!.videos!.length < categoryResponse!.count)) {
