...
class PaymentScreen extends StatefulWidget {
  ...
  PaymentScreen({Key? key, required this.plan, required this.selectedIndex, required this.subscriptionPlanId});
...
class _PaymentScreen extends State<PaymentScreen>{
                  ...
                  children: [
                    ...
                    Center(
                      child: Padding(
                        ...
                        child: Text("Select Payment Method", style: TextStyle(fontSize: 25.0,color: Colors.white,fontWeight: FontWeight.bold)),
                      ),
                    ),
                    Center(
                      child: Padding(
                        padding: const EdgeInsets.only(top: 4.0, left: 8.0, right: 8.0, bottom: 8.0),
                        child: Text("Choose Your Payment Mode", style: TextStyle(fontSize: 15.0,  color: Colors.grey),),
                      ),
                    ),
                    Container(
                      height: 200.0,
                                    ...
                                    Container(
                                        ...
                                        child: Center(
                                          child: Column(
                                            ...
                                            children: [
                                              Text("Total Payment",style: TextStyle(fontSize: 15.0,  color: Colors.white.withOpacity(0.5))),
                                              Text(widget.plan.planCosts![widget.selectedIndex]!.planCost!.split(" ")[0],style: TextStyle(fontSize: 35.0,color: Colors.yellow,fontWeight: FontWeight.bold)),
                                              Text("Premium Plan",style: TextStyle(fontSize: 15.0,  color: Colors.white)),
                                            ],
                                          ),
                                        )
                                    )
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                Expanded(flex: 2,child: Icon(Icons.credit_card_outlined, size: 25 ,color: Colors.white)),
                                Expanded(flex: 6,child: Text('Credit Card', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.white))),
                                Expanded(flex: 2, child: Icon(Icons.arrow_forward_ios, color: Colors.yellow,))
                              ],
                            ),
                          ),
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: () async {
                            ...
                            print(widget.plan.planCosts![widget.selectedIndex]!.planCost!);
                            print("selected="+widget.selectedIndex.toString());
                            Get.offAll(()=>PaypalScreen(planCost:widget.plan.planCosts![widget.selectedIndex]!.planCost!));
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                Expanded(flex: 2,child: Icon(Icons.credit_card_outlined, size: 25 ,color: Colors.white)),
                                Expanded(flex: 6,child: Text('Paypal', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.white))),
                                Expanded(flex: 2, child: Icon(Icons.arrow_forward_ios, color: Colors.yellow,))
                              ],
                            ),
                          ),
  ...
  Future<bool> displayPaymentSheet(SubscriptionInit sub) async{
    try{
     ...
     // Toast.show('Paid successfully', context,
  ...
  calculateAmount(String amount){
    ...
    print('amount='+amount.split(' ')[0].substring(1));
    final price = (double.parse(amount.split(' ')[0].substring(1))*100).round();
